...
if uploaded_file:
    with st.spinner("Analisando arquivo..."):
        ...
        if analyzer_results:
            st.error(f"🚨 **PRIVACY PARTNER:** The file `{uploaded_file.name}` contains sensitive information. **Recommended Action:** To procees, please anonymize or pseudononymize the data. You can use the **Privacy Partner Add-in for Excel** to help. ")
